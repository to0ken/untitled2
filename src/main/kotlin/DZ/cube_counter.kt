...
fun main() = KoolApplication{
    ...
    val cubeCounter = mutableStateOf(0)  // ← Добавили счётчик
    ...
    addScene {
        ...
        addPanelSurface {
            ...
            Row {
                ...
                Button(" Посчитать кубики") {
                    modifier.onClick {
                        cubeCounter.value += 1
                        pushLog(game, "[Счёт] Кубиков: ${cubeCounter.value}")
                    }
                }

                Text("  ${cubeCounter.use()}") {
                    modifier
                        .margin(start = 10.dp)
